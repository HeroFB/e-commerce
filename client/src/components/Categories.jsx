...
const Categories = () => {
  ...
  return (
    <div className='mt-16 '>
        ...
        <div className='grid grid-col-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 mt-6 gap-6 text-white'>
            ...
            {categories.map((category, index)=>(
                ...
                <p className='text-sm font-bold tracking-wide'>{category.text}</p>
            </div>
