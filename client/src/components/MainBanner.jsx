...
const MainBanner = () => {
  return (
    <div className='relative'>
        <img src={assets.main_banner_bg} alt="mainBannerBg" className='w-full hidden md:block'/>
        <img src={assets.main_banner_bg_sm} alt="mainBannerBgSm" className='w-full md:hidden'/>
