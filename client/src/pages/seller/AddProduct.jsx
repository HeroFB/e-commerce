    ...
    <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <div className="flex flex-col gap-1 max-w-md">
                    ...
                    <input onChange={(event)=> setName(e.target.value)} value={name} 
                ...
                <div className="flex flex-col gap-1 max-w-md">
                    ...
                    <textarea onChange={(event)=> setDescription(e.target.value)} value={description} 
                ...
                <div className="w-full flex flex-col gap-1">
                    ...
                    <select onChange={(event)=> setCategory(e.target.value)} value={category}
                ...
                <div className="flex items-center gap-5 flex-wrap">
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        ...
                        <input onChange={(event)=> setPrice(e.target.value)} value={price}
                    ...
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        ...
                        <input onChange={(event)=> setOfferPrice(e.target.value)} value={offerPrice}
